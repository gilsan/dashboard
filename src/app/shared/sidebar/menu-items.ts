...
export const ROUTES: RouteInfo[] = [
    {
        path: '', title: '현황판', icon: 'mdi mdi-view-quilt', class: 'has-arrow', label: '', labelClass: '', extralink: false,
        submenu: [
          { path: '/panel/grid', title: '현황판', icon: '', class: '', label: '', labelClass: '', extralink: false, submenu: [] },
        ]
    },
    {
        path: '/starter', title: 'Starter Page', icon: 'mdi mdi-gauge', class: '', label: '', labelClass: '', extralink: false,
        submenu: []
    },
    {
